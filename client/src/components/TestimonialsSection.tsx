  ...
  const testimonials = [
    {
      ...
      initials: "MC",
      rating: 5,
      review: "Travail impeccable sur notre toiture. L'équipe d'aqua-toiture-facade est professionnelle et le résultat dépasse nos attentes. Notre toit ressemble à neuf !",
      color: "bg-[#59D14C]"
    },
    {
      name: "Pierre L.",
