        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-[#59D14C] rounded-full flex items-center justify-center transition-colors duration-300">
          ...
          {/* Services */}
          <div>
            <h4 className="text-xl font-semibold mb-6 text-white">Nos Services</h4>
            <ul className="space-y-3">
              <li>
                <a href="#services" className="text-gray-300 hover:text-[#59D14C] transition-colors duration-300 flex items-center">
          ...
          <div>
            <h4 className="text-xl font-semibold mb-6 text-white">Zones d'Intervention</h4>
            <ul className="space-y-3">
              <li>
                <a href="#zones" className="text-gray-300 hover:text-[#59D14C] transition-colors duration-300 flex items-center">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+32123456789" className="text-white font-semibold hover:text-[#59D14C] transition-colors">
                    +32 123 456 789
                  </a>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              <a href="#" className="text-gray-400 hover:text-[#59D14C] transition-colors">
                Mentions légales
              </a>
              <a href="#" className="text-gray-400 hover:text-[#59D14C] transition-colors">
