        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-[#27851E] to-[hsl(199,89%,48%)] rounded-full flex items-center justify-center">
              ...
              {footerSections.services.map((service, index) => (
                <li key={index}>
                  <button 
                    ...
                    className="hover:text-[#27851E] transition-colors text-left"
                  >
                    {service.label}
                  </button>
                </li>
