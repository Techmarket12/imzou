      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {serviceAreas.map((area, index) => (
            <Card
              key={index}
              className="bg-gray-800/50 border-gray-700 backdrop-blur-sm hover:bg-gray-700/50 transition-all duration-300"
            >
              <CardContent className="p-8">
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-[#59D14C] mb-3">
                    Communes desservies :
                  </h4>
