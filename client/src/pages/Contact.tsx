    ...
    <div className="min-h-screen bg-gray-900">
      ...
      >
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-4">
          ...
          >
            Experts en nettoyage haute pression depuis 15 ans à Bruxelles et Brabant.
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Plusieurs moyens pour nous joindre et obtenir votre devis personnalisé
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <Card className="bg-gray-700/50 border-gray-600 text-center hover:border-[#59D14C] transition-colors duration-300">
              <CardHeader>
                ...
                <CardTitle className="text-white">Zone d'Intervention</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-gray-700/50 border-gray-600 hover:border-[#59D14C] transition-colors duration-300">
              ...
              <CardContent>
                <p className="text-gray-300 mb-4">
                  Estimation précise et détaillée sans engagement. Déplacement gratuit dans notre zone d'intervention.
                </p>
            ...
            <Card className="bg-gray-700/50 border-gray-600 hover:border-[#59D14C] transition-colors duration-300">
              ...
              <CardContent>
                <p className="text-gray-300 mb-4">
                  Nos spécialistes vous conseillent sur les meilleures solutions pour votre type de surface.
                </p>
                <ul className="text-sm text-gray-400 space-y-1">
            ...
            <Card className="bg-gray-700/50 border-gray-600 hover:border-[#59D14C] transition-colors duration-300">
              ...
              <CardContent>
                <p className="text-gray-300 mb-4">
                  Satisfaction garantie ou nous recommençons. Assurance responsabilité civile incluse.
                </p>
                <ul className="text-sm text-gray-400 space-y-1">
              ...
              {[
                {
                  ...
                  answer: "Nous intervenons principalement à Bruxelles-Capitale et dans le Brabant Wallon. Notre zone d'intervention couvre un rayon de 50km autour de Bruxelles, incluant Wavre, Nivelles, Hal, Vilvorde, et leurs environs."
                },
                {
                  question: "Combien coûte un nettoyage de toiture ?",
                  answer: "Le prix varie selon la superficie, le type de toiture et l'état de salissure. Nos tarifs débutent à 8€/m² pour un nettoyage standard. Un devis gratuit et personnalisé vous sera proposé après visite sur site."
                },
                {
                  question: "Combien de temps prend une intervention ?",
                  answer: "La durée dépend de la surface et du type de nettoyage. En moyenne : 2-4h pour une terrasse, 4-8h pour une toiture, 3-6h pour une façade. Nous vous informons précisément lors du devis."
                },
                {
                  question: "Utilisez-vous des produits écologiques ?",
                  answer: "Oui, nous privilégions les produits biodégradables et respectueux de l'environnement. Nos techniques de nettoyage haute pression réduisent l'usage de produits chimiques."
                },
                {
                  question: "Proposez-vous des garanties ?",
                  answer: "Nous garantissons la qualité de nos interventions. Si le résultat ne vous satisfait pas, nous recommençons gratuitement. Nous sommes assurés responsabilité civile et décennale."
                },
                {
                  question: "Puis-je obtenir un devis par téléphone ?",
                  answer: "Nous pouvons vous donner une estimation par téléphone, mais un devis précis nécessite une visite sur site pour évaluer l'état des surfaces et définir la meilleure approche."
                }
              ].map((faq, index) => (
      ...
      <section className="py-20 bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Un processus simple et transparent, du premier contact à la réalisation
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Contactez-nous par téléphone, email ou formulaire. Nous vous rappelons sous 2h en journée.",
                icon: "fas fa-phone-alt"
              },
              {
                step: "2",
                title: "Visite Gratuite",
                description: "Nous venons évaluer vos besoins sur site. Diagnostic complet et conseils personnalisés.",
                icon: "fas fa-search"
              },
              {
                step: "3",
                title: "Devis Détaillé",
                description: "Proposition claire avec détail des prestations, délais et garanties. Sans engagement.",
                icon: "fas fa-file-invoice"
              },
              {
                step: "4",
                title: "Intervention",
                description: "Réalisation soignée par nos experts. Nettoyage complet et vérification qualité.",
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Remplissez ce formulaire simple pour recevoir votre devis personnalisé sous 24h.
                Nos experts vous recontacteront rapidement.
              </p>
            </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-700">
                <div className="grid md:grid-cols-3 gap-6 text-center">
                  ...
                  <div>
                    ...
                    <div className="text-white font-semibold">Devis Gratuit</div>
